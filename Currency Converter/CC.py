...
headlabel = tk.Label(Tops,font=('lato black', 19,'bold'), text = '      DEVESH    :    Currency Converter with GUI  ', bg= '#663300',fg='white') 
...
#Codes of all the currency used
CurrencyCode=['USD','EUR','JPY','GBP','AUD','CAD','CHF','CNY','SEK','MXN','NZD','SGD','HKD','NOK','KRW',
'TRY','INR','RUB','BRL','ZAR','DKK','PLN','TWD','THB','MYR']

#Taking values of currency from forex currency exchange
...
FromCurrency_option = tk.OptionMenu(root, variable1, *CurrencyCode) 
ToCurrency_option = tk.OptionMenu(root, variable2, *CurrencyCode) 
